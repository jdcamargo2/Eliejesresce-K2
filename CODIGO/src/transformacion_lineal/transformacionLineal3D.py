"""
Este programa aplica una transformación lineal 3D a un vector y a un cubo,
mostrando gráficamente el vector original, el vector transformado,
los ejes originales, los ejes transformados y la deformación del espacio.
"""
...
A = np.array([[1, 0.2, 0.0], [0.3, 1, 0.1], [0.0, 0.2, 1]])
...
verts = (
    verts_list.T
)  # (3,8) para respetar tu formato original si lo necesitas en columnas
...
ax.quiver(
    0, 0, 0, 1, 0, 0, color="crimson", linewidth=2, alpha=0.9, label="Ejes originales"
)
