"""
Este programa aplica una transformación lineal 2D a un vector y a una rejilla,
mostrando gráficamente el vector original, el transformado, el cambio de ángulo,
la variación de magnitud y la deformación del espacio.
"""
...
print(
    "||v|| = ",
    np.linalg.norm(v.ravel()),
    "    ||v'|| = ",
    np.linalg.norm(v_transformada.ravel()),
)
...
ax.set_ylim(-10, 15)
ax.legend()
ax.set_title("Transformación lineal: rejilla deformada")
plt.show()
